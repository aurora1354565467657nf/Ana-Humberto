...
<div id="services-area">
    <div class="container">
        <div class="row">
            <div class="col-12 mb-3">
                <h1 class="main-title">Bem vindo ao site!</h1>
            </div>
            <div class="col-md-4 services-box">
                <h4>Quimica 01</h4>
                <i class="fas fa-mobile-alt"><img style='width:100%'src="../static/jogo_qui1.jpg"></i>
            ...
            <div class="col-md-4 services-box">
                <h4>Quimica 02</h4>
                <i class="fas fa-mobile-alt"><img style='width:100%'src="../static/jogo_qui2.png"></i>
                <p>Lorem Ipsum é simplesmente um texto fictício da indústria tipográfica e de impressão.
                   Lorem Ipsum tem sido o texto fictício padrão da indústria desde os anos 1500, quando um impressor desconhecido pegou uma galera de tipos e os embaralhou para fazer um livro de espécimes de tipos.</p>
            </div>
            <div class="col-md-4 services-box">
            ...
            <div class="col-md-4 services-box">
                <h4>Matemática 02</h4>
                <i class="fas fa-mobile-alt"><img style='width:100%'src="../static/jogo_qui2.png"></i>
                <p>Lorem Ipsum é simplesmente um texto fictício da indústria tipográfica e de impressão. Lorem Ipsum tem sido o texto fictício padrão da indústria desde os anos 1500, quando um impressor desconhecido pegou uma galera de tipos e os embaralhou para fazer um livro de espécimes de tipos.</p>
              </div>
    ...
    <header class='nav_menu'>
        <div class='nav_menu_elements' id=''>
        </div>
        <div class='nav_menu_elements' id=''>
        </div>
    </header>
