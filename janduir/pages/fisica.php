    ...
    <div class="container">
        <div class="row">
            <div class="col-12 mb-3 mt-3 text-center">
                <h1 class="main-title ">Divirta-se com os nossos jogos de Física!</h1>
            </div>
            <div class="col-md-4 services-box">
                <h4>Física 01</h4>
                <i class="fas fa-mobile-alt"><img style='width:100%'src="../static/jogo_fis2.png"></i>
